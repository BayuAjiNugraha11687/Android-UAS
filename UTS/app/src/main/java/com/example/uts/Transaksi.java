...
public class Transaksi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kembalian = (EditText) findViewById(R.id.jumlahKembali);
        bayaran = (EditText) findViewById(R.id.jumlahPembayaran);
        editagihan = (EditText) findViewById(R.id.jumlahTransaksi);

        tagihan = findViewById(R.id.jumlahTransaksi);
