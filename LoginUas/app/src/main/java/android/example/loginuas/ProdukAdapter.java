...
public class ProdukAdapter extends
    ...
    public double tot=0;
    Context context;
    int gambar[] = {R.drawable.ayam2, R.drawable.bandeng1};
    public ProdukAdapter(ArrayList<Produk> dataList, Context
            context)
    {
    ...
    @Override
    public ProdukViewHolder onCreateViewHolder(ViewGroup parent,
                                               int viewType) {
    ...
    @Override
    public void onBindViewHolder(final ProdukViewHolder holder,
                                 int position){
...
//holder.icon.setImageResource(dataList.get(position).getImg());
    ...
    public class ProdukViewHolder extends
